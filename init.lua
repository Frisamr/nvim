...
-- INFO: After understanding a bit more about Lua, you can use `:help lua-guide` as a
...
-- NOTE: the options here are copied from the recommended options under `:h shell-powershell`
...
require('lazy').setup({
    ...
    config = function()
      ...
      require('mason-tool-installer').setup {
        ...
        integrations = {
          ...
          ['mason-null-ls'] = false,
          -- TODO: update this once I setup nvim-dap
  ...
  { -- If you want to see what colorschemes are already installed, you can use `:Telescope colorscheme`.
    ...
    lazy = false, -- Needed for priority to apply properly.
...

  {
    ...
    config = function()
      ...
      require('mini.surround').setup {
        ...
        --
        -- Use leap.nvim recommended compatible mappings. See
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- TODO: set nvim-treesitter to use curl instead of git, as explained here:
    ...
    opts = {
      ...
      -- PNOTE: autoinstall is just annoying as it needs to download the
      -- parser and spin up a C compiler every time. By the time it completes,
      -- I'm usually done editing the file anyway.
      auto_install = false,
      highlight = {
        enable = true,
